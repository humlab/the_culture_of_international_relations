...
layout_setups = [
    bunch(
        key="nx_spring_layout",
        package="nx",
        name="nx_spring",
        layout_network=nx_spring_layout,
    ),
    bunch(
        key="nx_spectral_layout",
        package="nx",
        name="nx_spectral",
        layout_network=nx_spectral_layout,
    ),
    bunch(
        key="nx_circular_layout",
        package="nx",
        name="nx_circular",
        layout_network=nx_circular_layout,
    ),
    bunch(
        key="nx_shell_layout",
        package="nx",
        name="nx_shell",
        layout_network=nx_shell_layout,
    ),
    bunch(
        key="nx_kamada_kawai_layout",
        package="nx",
        name="nx_kamada_kawai",
        layout_network=nx_kamada_kawai_layout,
    ),
]
