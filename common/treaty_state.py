...
treaties_column_names = [
    'sequence', 'treaty_id', 'is_cultural_yesno_org', 'is_cultural_yesno_plus', 'is_cultural_yesno_gen', 'english', 'french', 'other', 'source', 'vol', 'page', 'signed',
...
class TreatyState:
    ...
    def __init__(self, data_folder='./data', skip_columns=default_treaties_skip_columns, period_groups=None, filename=None, is_cultural_yesno_column='is_cultural_yesno_org'): # pylint: disable=W0102
