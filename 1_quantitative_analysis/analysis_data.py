    ...
    def get_treaties_statistics(
        ...
        *,
        ...
        if 'ALL' in parties:
            ...
            df_top: pd.DataFrame = QuantityByParty.get_top_parties(df, period_group=period_group, party_name=party_name, n_top=n_top)\
...
class QuantityByTopic():
    ...
    @staticmethod
    def get_quantity_of_categorized_treaties(treaties: pd.DataFrame, period_group: dict[str, Any], topic_category: dict[str, str], recode_is_cultural: bool):
    ...
    def get_treaty_topic_quantity_stat(
        ...
        if target_quantity == 'topic':
            ...
            data: pd.DataFrame = parties_treaties\
            ...
            stacked_treaties: pd.DataFrame = pd.merge(wti_index.stacked_treaties[['party', 'party_other']], categorized_treaties, left_on='treaty_id', right_index=True, how='inner')
